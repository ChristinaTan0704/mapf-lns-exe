...
int main(int argc, char** argv)
{
	...
	desc.add_options()
        ...
        ("adaptive_weight", po::value<std::vector<double>>()->multitoken()->default_value(std::vector<double>{1.0, 1.0, 0.0}, "1.0 1.0 1.0"), "weight for the adaptive strategy")
        ("replanAgents,ra", po::value<std::vector<int>>()->multitoken()->default_value(std::vector<int>{1}, "1"))
